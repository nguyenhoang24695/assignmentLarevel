@extends('layouts.header')
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" id="navbarDropdown1" data-target="#" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Chơi gì</a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                <li><a class="dropdown-item" href="leisure-and-dining.html">Vui chơi</a></li>
                <li><a class="dropdown-item" href="restaurant.html">Ẩm thực</a></li>
              </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="cart.html"><span style="font-size:20px;" class="fa fa-shopping-cart"></span></a>
            </li>
          </ul>
        </div>
      </div>
  	...
  	<div class="product-wrap">
  		<div class="container">
  			<div class="row" id="result">
  				...
  				<div class="col-lg-4">
  					<div id="booking-bar" class="vue-affix affix">
  						<div class="booking-bar-content">
  							<div class="price">
  								...
  								<div class="pull-right">
  									<div class="product-pricing">
  										<h4>VND </h4>
  										<h2 class="text-primary product-price">300000</h2>
  									</div>
  								</div>
  							...
  							<div class="space"></div>
  							<div class="btn btn-outline-secondary btn-lg btn-block">
  								<span>
  									<i class="fa fa-heart" aria-hidden="true"></i>&nbsp;Thêm vé
  								</span>
  							</div>
  						</div>
  					</div>
  					...
  					<div class="recent-review">
  						...
  						<div class="review-item">
  							<div class="review-content">
  								...
  								<p>Trải nghiệm công viên rất tuyệt vời. Đây là lần đầu tiên tôi đến đây và chắc chắn sẽ quay trở lại lần nữa để thử thêm nhiều trò chơi mới.</p>
  							</div>
  							<div class="review-content">
  								<h5>Hồng Luyến</h5>
  								<div class="product-star">
  								...
  								<p>Quả đáng đồng tiền bát gạo. Đẳng cấp quốc tế là đây. Nhân viên nhiệt tình và tận tâm. Tôi rất hài lòng với trải nghiệm này. Mong rằng lần sau quay lại, công viên sẽ phát triển hơn nữa.</p>
  							</div>
  						</div>
  					</div>
  				</div>
    ...
    <a href="ticketlist.html" class="js-back-to-top back-to-top back-to-top-is-visible">Back</a>
